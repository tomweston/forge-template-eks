...
// RegisterAutoTags registers a stack transformation that will automatically apply the given tags to all taggable
// Reference:  https://github.com/joeduffy/aws-tags-example/tree/master/autotag-go
